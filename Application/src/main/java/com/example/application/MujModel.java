...
*/
    ...
    public Collection<Item> pridejZaznam(String Nazev, double celkova_castka, double nasetrena_castka) {
        Item newItem = new Item(Nazev, celkova_castka, nasetrena_castka);
        // Zde přidáme nový záznam do seznamu
        // Tuto část implementace ještě doplňte o přidání nového záznamu do tabulky (neimplementováno v této metodě)
        return FXCollections.singletonObservableList(newItem);
    }
}
